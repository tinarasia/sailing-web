...
Cast off from Port de Pollença bound for Cala Castell — a modest half-day's sail, 18 nautical miles at an average of 2.5 knots. Wind 1–5 kn from the NNE, gusting to 16 kn. It veered from NNW to ENE. Current up to 0.6 kn setting E. Logbook only, for now — the real story of the passage itself is still waiting to be filled in.
