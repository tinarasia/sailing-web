...
![Watercolor-style map of the route from Port de Sóller to Sant Carles de la Ràpita: a navy track line with a gold circle marking the start and a dark square marking the end](/img/tracks/trip25-port-de-soller-to-sant-carles-de-la-rapita.png){: width="256" style="display:block; margin-left:auto; margin-right:auto"}
